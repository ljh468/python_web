    ...
    for i in siteList:
        ...
        for j in range(2, 4):
            driver.find_element_by_xpath(
                f'//*[@id="container"]/div[2]/div[1]/div[2]/div[3]/div/ul/li[{j}]/div[1]/a').click()
            CONTEST_NAME = driver.find_element_by_xpath(
                '//*[@id="container"]/div[2]/div[1]/div[2]/div/div[1]/h6').text  # 공모전 이름
